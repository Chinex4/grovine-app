...
export const AppSplashScreen = ({ navigation }: any) => {
    ...
    const logoUri = Asset.fromModule(require('../../assets/images/grov1.svg')).uri;
    ...
    useEffect(() => {
        ...
        const runBootFlow = async () => {
            ...
            const storedAccessToken = await appStorage.getItem(STORAGE_KEYS.accessToken);
            const storedRefreshToken = await appStorage.getItem(STORAGE_KEYS.refreshToken);
